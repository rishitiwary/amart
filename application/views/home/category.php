    ...
    <div class="category-main">
      ...
      <div class="right">
        <div class="header-banner">
          <figure><img src="<?= base_url()?>images/categorypage/banner.jpg"></figure>
      ...
      <div class="left">
        <div class="category-box-heading">
          <span class="text-cate">All Sub Category</span>    
        </div>
        ...
        <div class="category-box">
          <ul>
            ...
            <li> <a href="<?=base_url()?>home/subcategory/<?=$cat->id?>/<?=$sub->id?>"><?=$sub->category?></a>  </li>
             <?php endforeach ?>
           <?php } else{?>
        ...
        <div class="sidebar-products">
          ...
          <!-- end .sidebar-products-list -->
            <?php endforeach ?> 
            <?php //if(count($bestsellinglist)>0) { ?>
