...
<ul>
    <li><span>
        <figure><img src="<?= base_url()?>images/home/how-it-works.svg"></figure>
        <p>Place Order</p>
    </span>
    </li>
    <li>
    ...
    <li>
        <figure><img src="<?= base_url()?>images/home/order-confirmation.svg"></figure>
                        ...
                        <div class="content">
                            <div class="feature-box-inner clearfix">
                                <div class="fbox-icon">
                                    ...
                                    <img src="<?= base_url()?>images/home/quality.png" width="30px" alt=""/>
                                </div>
                                <div class="fbox-content ">  
                                    <h3 class="ourservice-heading">Quality :</h3>
                                    <div class="description">We guarantee you the best, handpicked quality from our side. Freshness and quality is our main priority to keep the customers satisfied and maintain our goal. The freshness of our products is maintained by our daily supplying plan team.</div>  
                                </div> 
                            </div>
                             <div class="feature-box-inner clearfix">
                                <div class="fbox-icon">
                                    <!--<i class="fa fa-heart"></i>-->
                                    <img src="<?= base_url()?>images/home/service.png" width="30px" alt=""/>
                                </div>
                                <div class="fbox-content ">  
                                    <h3 class="ourservice-heading">Service :</h3>
                                    <div class="description">We provide the best personal service to assist and help you to fulfil your necessities. We treat and look at our customers as family, and always push to provide the best of the best for them. Our team is always eager to provide the best services for your satisfaction. Providing the best service to all our customers, whether a 1DHS customer or 500DHS customer, we are all family. We guarantee if there is any issue that can be solved from our side, we will solve it together with ease and satisfaction guaranteed.</div>  
                                </div> 
                            </div>
                            ...
                            <div class="feature-box-inner clearfix">
                                <div class="fbox-icon">
                                    <!--<i class="fa fa-truck"></i>-->
                                     <img src="<?= base_url()?>images/home/price.png" width="30px" alt=""/>
                                </div>
                                <div class="fbox-content ">  
                                    <h3 class="ourservice-heading">Pricing :</h3>
                                    <div class="description">The best pricing for the best quality and service provided. Every product that you purchase is worth every single Dirham you pay. You will know how our items are priced after one time of ordering with us.</div>  
                                </div> 
                            </div>
                        </div>
        ...
        <div id="home-slider" class="carousel slide container" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <?php $i = 0; foreach ($drinks as $key => $drink): ?>
                             ...
                             ?>
                                <li>
                                    ...
                                    <div class="price-box">
                                        ...
                                        <?php
                                        if($drink->offer_percentage!="0" && $drink->offer_price!=$drink->price){
                                        ?>
                    ...
                    <?php $i++; if($i == 4 or $totaldrinks == $drinksseq){ ?>                                
                        </ul>
                    </div>
                    
                <?php $i = 0; }    $drinksseq++; endforeach 
                //} 
                ?> 
            </div>
        </div>
...
<div class="slider">
    <div class="heading-comman container">
        ...
        <div id="home-slider_fruits" class="carousel slide container" data-ride="carousel">
            <div class="carousel-inner">
                <?php
                //$cat=@ $fruitbasket[0]->category_id; 
                $type=@ $fruitbasket[0]->product_type; 
                //$latestpro = $this->Commonmodel->fetch_by_limit_offset('products', $where, 4, $offset);
                 $totallatest= count( $fruitbasket); ?>
                <?php $latestseq=1; for ($i=0; $i<(ceil($totallatest/4)); $i++) { ?>
                    <div class="carousel-item <?php if($latestseq=='1'){ echo 'active'; }?>">
                        <ul class="product-listing">
                            ...
                            foreach ($fruitbasket as $key => $latests): ?>
                                <li>
                                    ...
                                    <div class="price-box">
                                        ...
                                        <?php
                                        if($latests->offer_percentage!="0" && $latests->offer_price!=$latests->price){
                                        ?>
                        ...
                        foreach ($veglimt as $key => $veg): ?>
                            <li>
                                ...
                                <div class="price-box">
                                    ...
                                    <?php
                                    if($veg->offer_percentage!="0" && $veg->offer_price!=$veg->price){
                                    ?>
  ...
  <div class="tab-pane fade" id="best-selling" role="tabpanel" aria-labelledby="best-selling-tab">
    <div id="profile-slider" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            ...
            $total= count($data[0]['products']);  
            $cat=$data[0]['products'][0]->category_id; 
             $bestseq=1; 
             for ($i=0; $i<(ceil($total/4)); $i++) { ?>
           ...
           <li>
            ...
            <div class="price-box">
                <div class="price">₹ <?= number_format($fruit->offer_price, 2)?></div>
                 <?php
                if($fruit->offer_percentage!="0" && $fruit->offer_price!=$fruit->price){
                ?>
           ...
           <li>
            ...
            <div class="price-box">
                <div class="price">₹ <?= number_format($offer->offer_price, 2)?></div>
                 <?php
                if($offer->offer_percentage!="0" && $offer->offer_price!=$offer->price){
                ?>
