  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="<?=base_url('home/offers')?>">Offers</a></li>
      </ol>
    </nav>
  </div>
</div>
      ...
      <div class="left">
        ...
        <div class="category-box">
          <ul>
            ...
            <?php foreach ($categories as $key => $sub): ?>           
            <li> <a href="<?=base_url()?>home/category/<?=$sub->id?>"><?=$sub->category?></a>  </li>
             <?php endforeach ?>
           <?php } else{?>
