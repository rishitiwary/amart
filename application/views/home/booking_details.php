...
<table width="100%" align="center">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background: #fff;  font-size: 14px">
        ...
        {  
            ...
            { 
                ...
                <tr>
                    ...
                    <td style="padding-left:30px; border-bottom: 1px solid #F5F5F5" height="40">₹ <?=number_format($subTotal, 2);?></td>
                </tr>
                <?php $counter++;
            } 
        ...
        <tr>
            ...
            <td style="padding-left:30px" height="40"><strong><?php echo '₹ '.' '.  number_format($subTotal, 2);?></strong></td>
        </tr>

          <tr>
            <td height="40" colspan="4" align="right" style="padding-right:30px; border-bottom: 1px solid #F5F5F5"><strong>VAT 5%</strong></td>
            <td style="padding-left:30px" height="40"><strong>AED
            <?php 
            $vat = (5 / 100) * @$subTotal ; 
        ...
        <tr>
            ...
            <td style="padding-left:30px" height="40"><strong>
                <?php echo '₹ '.' '. number_format($deliveryCharge, 2);?>
                </strong></td>
        </tr>
        <?php 
        $sameDay= 0;
       $type=@$fetch_data[0]->delivery_type;
        ...
        <tr>
            ...
            <td style="padding-left:30px" height="40"><strong>₹ <?= number_format($sameDay, 2) ?></strong></td>
        </tr>
    ...
    <table width="100%" style="background: #F5F5F5; padding: 20px 0 ">
        ...
        <table width="100%" style="background:#B60008; color: #fff; padding: 30px">
            ...
            <!--<tr><td>We are here to help, learn more about us here  <a href="mailto:Yaldafresh@gmail.com" style="color: #fff; text-decoration: none">Contact us</a></td></tr>-->
            <tr><td>We are here to help, Contact Mail : <a href="mailto:Yaldafresh@gmail.com" style="color: #fff; text-decoration: none">Yaldafresh@gmail.com</a></td></tr>
            <tr><td>+97154 365 8181 / 04 349 6045</td></tr>
        </table>
