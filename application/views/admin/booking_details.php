            ...
            <table class="table">
                ...
                ?>  
                    <tr>  
                        ...
                        <td><?php echo $fetch_data[0]->customer_name; ?></td>
            ...
            <table class="table">
                ...
                <?php       
                   ...
                   <tfoot>
                        ...
                        <?php if($fetch_data[0]->discount_percentage != ""){ ?>
                        <tr>
                            <td colspan="5" style="text-align:right;"><b>Discount Percentage:</b></td>
                            <td style="text-align:left;"><b> <?php echo $fetch_data[0]->discount_percentage.' % Discount(Coupon Applied)';?></b></td>
                        </tr>
                        <?php }?>
                        ...
                        <?php }
                               ...
                               <?php }
                                ...
                                $amount=$subTotal-$amount;
                               ?>
                                    <td colspan="5" style="text-align:right;"><b>Grand Total  <?php /*echo $fetch_data[0]->discount_percentage.' % Discount(Coupon Applied)';*/?> :</b></td>
                                    <td style="text-align:left;"><b><?php echo '₹ '.($deliveryCharge+abs($amount));?></b></td>
                                <?php }
                            } ?>
                    </tfoot>
