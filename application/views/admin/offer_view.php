...
<div class="panel">
    <div class="records--list" data-title="Offers Listing">
        <div class="topbar">
            <div class="toolbar">OFFERS LISTING</div>
            <div class="right">
                <div class="dataTables_length" id="recordsListView_length"></div>
            </div>
        </div>
        <table id="offerListView">
            <thead>
                <tr> 
                    <th>S No.</th>
            ...
            <?php  
                    ...
                    <tr>  
                        ...
                        <?php if($auth['role']==1){ ?>
                        <td><a href="<?php echo base_url(); ?>offer/delete/<?php echo $row->id;?>/<?php echo $row->image;?>" onclick="return confirm('Are you sure you want to delete this?')" class="delete_data btn btn-danger" id="<?php echo $row->id; ?>">Delete</a></td>  
                        <td><a href="<?php echo base_url(); ?>offer/update/<?php echo $row->id; ?>" class="btn btn-info">Edit</a></td> 
                        <?php } ?>
                    </tr>  
                    <?php 
                    $i++;      
