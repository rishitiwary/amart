...
<div class="records--body">
    <div class="title"> 
        <h6 class="h6">Update Promotional Product</h6>  
    </div>
    <div class="tab-content">
        <div class="tab-pane fade show active" id="tab01">
            <form action="<?php echo base_url();?>promotional/store" method="post" enctype="multipart/form-data">                                       <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                    <select id="categoryId" class="form-control" name="category_id" required onchange="">
...
<div class="records--body">
    <div class="title"> 
        <h6 class="h6">Insert Promotional Product</h6>  
    </div>
    <div class="tab-content">
        <div class="tab-pane fade show active" id="tab01">
            <form action="<?php echo base_url();?>promotional/store" method="post" enctype="multipart/form-data">                                       <div class="form-group row">
                ...
                <div class="form-group row"> 
                    ...
                    <div class="col-md-3"> 
                        <input id="OfferPercentage" placeholder="Percentage" type="number" step="any" value="0" name="offer_percentage" class="form-control" required>
                    </div>
                    <div class="col-md-3"> 
                ...
                <div class="form-group row">
                    <span class="label-text col-md-3 col-form-label">Category:</span>
                    <div class="col-md-9">
                    <select id="categoryId" class="form-control" name="category_id" required onchange="fetchSubcategories()">
                        <option value="">Select Category ....</option>
                        <?php  
                        if(count($fetch_category) > 0)  
                        {  
