            ...
            <?php  
                ...
                ?>  
                    <tr>  
                            ...
                            <td><a href="<?php echo base_url(); ?>PromotionalCategory/delete/<?php echo $row->id;?>/<?php echo $row->image;?>" onclick="return confirm('Are you sure you want to delete this?')" class="delete_data btn btn-danger" id="<?php echo $row->id; ?>">Delete</a></td>
                            
                            <td><a href="<?php echo base_url(); ?>PromotionalCategory/update/<?php echo $row->id; ?>" class="btn btn-info">Edit</a></td> 
                    </tr>  
                <?php 
                $i++;      
                    }  
