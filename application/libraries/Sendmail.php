...
class SendMail{
    ...
    public function sendRegister($ls,$em,$link,$tLe)
    {
        ...
        $message .= '<br>';
        $message .= 'Before you can login, you need to activate  your ';
        $message .= '<br>';
    ...
    $config['smtp_host']    = 'mail.yaldafresh.com';
    $config['smtp_port']    = '587';
    $config['smtp_timeout'] = '60';

    $config['smtp_user']    = 'support@yaldafresh.com';    //Important
    $config['smtp_pass']    = '~mawc7S=bP)l';  //Important
